...
import { IconCashBanknote, IconFlask, IconHeartbeat, IconLayoutGrid, IconUser } from "@tabler/icons-react"
...
const links = [
  { name: "Dashboard", url: "/lab_technician/dashboard", icon: <IconLayoutGrid stroke={1.5} /> },
  { name: "Lab Requests", url: "/lab_technician/requests", icon: <IconFlask stroke={1.5} /> },
  { name: "Profile", url: "/lab_technician/profile", icon: <IconUser stroke={1.5} /> },
  { name: "My Salary", url: "/lab_technician/salary", icon: <IconCashBanknote stroke={1.5} /> },
